...
$logoUrl = "https://raw.githubusercontent.com/Misterun0m/backend/main/logo.jpeg";
...
$mensaje .= '<img src="' . $logoUrl . '" width="70" height="70" alt="Inicio Ciudadano" style="display:block;border-radius:4px;">';
$mensaje .= '</td></tr>';
